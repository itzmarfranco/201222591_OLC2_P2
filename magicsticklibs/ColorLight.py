...
def ty():
    ...
    #builtinlist.remove('print') quitar palabras reservadas 
    #  quitar palabras reservadas

    builtinlist.clear()

    # agregar nuestras palabras reservadas

    builtinlist.append('main') # main
    builtinlist.append('goto') # goto
    builtinlist.append('if') # if
    builtinlist.append('print') # print
    builtinlist.append('read') # read
    builtinlist.append('exit') # exit
    builtinlist.append('xor') # xor
    builtinlist.append('int') # int
    builtinlist.append('float') # float
    builtinlist.append('char') # char
    builtinlist.append('array') # array
    builtinlist.append('abs') # abs

    builtin = r"([^.'\"\\#]\b|^)" + any("BUILTIN", builtinlist) + r"\b" # palabras python
